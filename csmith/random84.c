...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[7] = {0xCE53D8DAL,0xCE53D8DAL,0xCE53D8DAL,0xCE53D8DAL,0xCE53D8DAL,0xCE53D8DAL,0xCE53D8DAL};
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &g_4[6];
    int32_t *l_7 = (void*)0;
    int32_t *l_8[4] = {&g_4[6],&g_4[6],&g_4[6],&g_4[6]};
    uint16_t l_9 = 0x720BL;
    int i;
    l_9++;
    return g_4[0];
}

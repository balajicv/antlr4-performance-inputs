...
static int32_t *g_7[6] = {&g_2[2],&g_2[2],&g_2[2],&g_2[2],&g_2[2],&g_2[2]};
static int32_t ** volatile g_6 = &g_7[4];/* VOLATILE GLOBAL g_6 */
static struct S0 g_9 = {4526,12,3};/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    uint16_t l_8 = 0UL;
    for (g_2[0] = 0; (g_2[0] > (-9)); --g_2[0])
    { /* block id: 3 */
        int32_t *l_5[7][7] = {{&g_2[3],&g_2[1],&g_2[0],&g_2[2],&g_2[2],&g_2[0],&g_2[1]},{&g_2[2],&g_2[3],&g_2[3],&g_2[0],(void*)0,(void*)0,(void*)0},{&g_2[3],&g_2[3],&g_2[2],&g_2[3],&g_2[3],&g_2[0],(void*)0},{&g_2[0],&g_2[1],&g_2[3],&g_2[0],&g_2[1],&g_2[0],&g_2[3]},{(void*)0,(void*)0,&g_2[0],&g_2[2],&g_2[1],(void*)0,&g_2[0]},{&g_2[0],&g_2[0],(void*)0,(void*)0,&g_2[0],&g_2[2],&g_2[1]},{&g_2[0],(void*)0,&g_2[2],&g_2[1],&g_2[3],&g_2[3],&g_2[1]}};
        int i, j;
        (*g_6) = l_5[5][1];
        if (l_8)
            continue;
